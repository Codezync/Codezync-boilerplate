...
/**
 * Created by Thufail on 10/18/2019.
 */
...
//        String url = "https://maps.googleapis.com/maps/api/directions/" + output + "?" + parameters;
    ...
    public String downloadUrl(String strUrl) throws IOException {
        LogUtil.debug(TAG, "Executing downloadUrl");
        String data = "";
        ...
        try {
            ...
            LogUtil.debug("Exception while url", e.toString());
        } finally {
            iStream.close();
    ...
    public class DownloadTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... url) {
            LogUtil.debug("Location", "do in back");
            ...
            try {
                ...
                LogUtil.debug("Background Task", e.toString());
            }
            return data;
        }
        ...
        protected void onPostExecute(String result) {
            ...
            LogUtil.debug("Location", "on post");
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>> {
        ...
        protected List<List<HashMap<String, String>>> doInBackground(String... jsonData) {
            LogUtil.debug(TAG, "Executing ParserTask");
            JSONObject jObject;
        ...
        protected void onPostExecute(List<List<HashMap<String, String>>> result) {
            LogUtil.debug(TAG, "Executing onPostExecute");
            ...
            if (result != null) {
                ...
                for (int i = 0; i < result.size(); i++) {
                    ...
                    LogUtil.debug("Locations= ", points.size() + "");
