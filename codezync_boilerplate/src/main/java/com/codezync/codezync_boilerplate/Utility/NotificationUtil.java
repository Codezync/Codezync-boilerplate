...
//                })
    ...
    public static void requestGPSOnMessage(Activity activity,String title,String message) {
        NotificationUtil.showSnakeBarMessage(activity, AlertType.ERROR, title, message, new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MapUtility.GPSOnRequest(activity);
            }
        });
    }
